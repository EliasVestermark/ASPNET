    ...
    public partial class Database : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_WhatYouLearns", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CourseIncludes", x => new { x.CoursesId, x.IncludesId });
                    table.ForeignKey(
                        name: "FK_CourseIncludes_Courses_CoursesId",
                        column: x => x.CoursesId,
                        principalTable: "Courses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CourseIncludes_Includes_IncludesId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CourseProgramDetails", x => new { x.CoursesId, x.ProgramDetailsId });
                    table.ForeignKey(
                        name: "FK_CourseProgramDetails_Courses_CoursesId",
                        column: x => x.CoursesId,
                        principalTable: "Courses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CourseProgramDetails_ProgramDetails_ProgramDetailsId",
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    CoursesId = table.Column<int>(type: "int", nullable: false),
                    WhatYouLearnsId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_CourseWhatYouLearn", x => new { x.CoursesId, x.WhatYouLearnsId });
                    table.ForeignKey(
                        name: "FK_CourseWhatYouLearn_Courses_CoursesId",
                        column: x => x.CoursesId,
                        principalTable: "Courses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CourseWhatYouLearn_WhatYouLearns_WhatYouLearnsId",
                        column: x => x.WhatYouLearnsId,
                        principalTable: "WhatYouLearns",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CourseIncludes_IncludesId",
                table: "CourseIncludes",
                column: "IncludesId");

            migrationBuilder.CreateIndex(
                name: "IX_CourseProgramDetails_ProgramDetailsId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CourseWhatYouLearn_WhatYouLearnsId",
                table: "CourseWhatYouLearn",
                column: "WhatYouLearnsId");
